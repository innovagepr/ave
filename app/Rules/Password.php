    ...
    public function message()
    {
        ...
        switch (true) {
            case $this->requireUppercase
                ...
                return __('La contraseña debe tener al menos :length caracteres y contener al menos una letra mayúscula.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireNumeric
                ...
                && ! $this->requireSpecialCharacter:
                return __('La contraseña debe tener al menos :length caracteres y contener al menos un dígito.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireNumeric
                && ! $this->requireSpecialCharacter:
                return __('La contraseña debe tener al menos :length caracteres y contener al menos una letra mayúscula y un dígito.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireSpecialCharacter
                && ! $this->requireNumeric:
                return __('La contraseña debe tener al menos :length caracteres y contener al menos una letra mayúscula y un caracter especial.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireNumeric
                && $this->requireSpecialCharacter:
                return __('La contraseña debe tener al menos :length caracteres y contener al menos una letra mayúscula, un dígito y un caracter especial.', [
                    'length' => $this->length,
                ]);
