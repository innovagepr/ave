...
<div class="main-block-normal mt-7">
    ...
    <div>
        ...
        <div class="dashboard-card lg-block ">
            <div class="card-content card-text m-auto pt-1 flex flex-col">
                <div class="flex flex-row">
                    <div class="text-right level">
                        {{$level}}
                    </div>
                    <progress class="m-auto mt-4" value="{{$points}}" max="{{$maxLevel}}"></progress>
        ...
        <div class="dashboard-card lg-block">
            <div class="card-content card-text m-auto pt-1 flex flex-col">
                <div class="flex">
                    ...
                    <progress class="m-auto mt-4" value="{{$petPoints}}" max="{{$maxPetLevel}}"></progress>
                    <div class="text-right level">
    ...
    <div>
        ...
        <div class="dashboard-card lg-block">
            ...
            @else
                <x-jet-label class="my-auto">{{__('No ha realizado ninguna actividad.')}}</x-jet-label>
            @endif
        </div>
    </div>
    {{--@endif--}}
